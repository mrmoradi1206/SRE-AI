...
SUPERVISOR_CONFIDENCE_THRESHOLD = float(os.getenv('SUPERVISOR_CONFIDENCE_THRESHOLD', '0.6'))
...
SUPERVISOR_OBSERVABILITY_TIMEOUT_SECONDS = float(os.getenv('SUPERVISOR_OBSERVABILITY_TIMEOUT_SECONDS', '45'))
SUPERVISOR_REPO_TIMEOUT_SECONDS = float(os.getenv('SUPERVISOR_REPO_TIMEOUT_SECONDS', '20'))
