...
LLM_CALLS = Counter('sre_ai_llm_calls_total', 'LLM calls by provider/model/status', ['provider', 'model', 'status'])
LLM_LATENCY = Histogram('sre_ai_llm_call_duration_seconds', 'LLM call latency', ['provider', 'model'])
