...
DEFAULT_SYSTEM_PROMPTS = {
    ...
    'observability': (
        ...
        'Separate confirmed findings from hypotheses. If a backend query fails, names cannot resolve, or data is empty, state that explicitly and reduce confidence and evidence_quality. '
